...
namespace Task2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Account account1 = new Account("Larry", 3000);
            Account account2 = new Account("Moe", 4000);

            Account sumAccount = account1 + account2;
            Console.WriteLine();
            Console.WriteLine();
            Console.WriteLine("****************");
            Console.WriteLine($"Sum Account Balance: {sumAccount.balance}");
